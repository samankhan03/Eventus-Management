                    ...
                    <div class="p-6 bg-white border-b border-gray-200">
                        <form @submit.prevent="submit">
                            ...
                            <div class="mb-6">
                                ...
                                <img v-if="props.event.image" :src="showImage() + props.event.image"
                                    class="object-cover h-40 w-80" alt="Current Event Image" />
                                <p v-else class="text-gray-500">No current image</p>
                            </div>
                            ...
                            <div class="mb-6">
                                ...
                                <input type="file" name="image" @input="handleImageChange" />
                                <div v-if="imagePreview" class="mt-2">
                                    <img :src="imagePreview" class="object-cover h-40 w-80"
                            ...
                            <button type="submit"
                                class="inline-flex items-center justify-center px-4 py-2 bg-black border border-transparent rounded-md font-semibold text-white uppercase tracking-widest hover:bg-blue-500
                                focus:outline-none focus:border-black focus:shadow-outline-black active:bg-gray-900 transition ease-in-out duration-150 text-sm"

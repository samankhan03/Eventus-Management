<template>
        <div class="flex flex-col min-h-screen homepage font-sans">
                    ...
                    <div class="flex">
                        ...
                        <div class="flex-shrink-0 flex items-center">
                            <inertia-link :href="route('dashboard.index')" class="h-3/4 w-16">
                                <img :src="'/storage/images/logo.png'" alt="logo" class="logo-dashboard">
                            </inertia-link>
                        </div>
                        ...
                        <div class="hidden space-x-8 sm:ml-10 sm:flex items-center">
                            <h1 class="subheading"> Eventus </h1>
                        </div>
                            ...
                            <jet-dropdown align="left" width="48">
                                <template #trigger>
                                    <button v-if="$page.props.jetstream.managesProfilePhotos"
                                        class="flex items-center text-sm border-2 border-transparent rounded-full focus:outline-none focus:border-transparent transition duration-150 ease-in-out text-white">
        ...
        <div class="flex-grow flex mt-28 sm:flex-nowrap gap-4">
    <!-- Page Sidebar -->
    <side-bar></side-bar>

    <!-- Page Content -->
    <main class="bg-gray-300 text-gray-800 shadow rounded mb-9 py-6 px-4 w-full sm:w-2/3 sm:mx-2 sm:mb-9 md:mx-4 md:px-10 lg:mx-auto font-sans">
        <slot></slot>
    </main>
</div>
        ...
        <footer class="footer bg-gray-800 text-white py-4">
            <p class="text-center">&copy; {{ currentYear }} Eventus. All Rights Reserved.</p>
        </footer>
    </div>
</template>

    ...
    <div class="flex border-t border-gray-400 mt-5 py-5 space-x-5">
        ...
        <div class="flex-1">
            <div>
                ...
                <p class="bg-gray-100 rounded mt-3 px-3 py-2 text-black">
                    {{ comment.body }}
                </p>
            </div>
            <div class="flex items-end my-3">
                <div>
                    <span class="text-sm italic text-black">{{ comment.timeAgo }}</span>
                </div>
                <div class="flex ml-3">
                    <like :item="comment" :method="submitLike" class="text-black"></like>
                    <dislike :item="comment" :method="submitDislike" class="ml-2 text-black"></dislike>
                </div>
            </div>
        </div>
    </div>
